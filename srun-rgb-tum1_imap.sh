...
srun --partition=xr_research --mpi=pmi2 --gres=gpu:1 -n 1 --ntasks-per-node=1 --job-name=tum1imap-rgb-bl --kill-on-bad-exit=1 python -W ignore run.py configs/TUM_RGBD/freiburg1_desk-rgbonly_imap.yaml --imap >log/t1imap-rgbonly.log
