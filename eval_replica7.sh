...
srun --partition=xr_research --mpi=pmi2 --gres=gpu:1 -n 1 --ntasks-per-node=1 --job-name=fixorb-office1 --kill-on-bad-exit=1 python -W ignore run.py configs/Replica/office1orb.yaml >log/office1orbfix.log