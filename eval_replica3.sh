...
srun --partition=xr_research --mpi=pmi2 --gres=gpu:1 -n 1 --ntasks-per-node=1 --job-name=fixorb-office3 --kill-on-bad-exit=1 python -W ignore run.py configs/Replica/office3orb.yaml >log/office3orbfix.log
srun --partition=xr_research --mpi=pmi2 --gres=gpu:1 -n 1 --ntasks-per-node=1 --job-name=fixorb-office3-prior --kill-on-bad-exit=1 python -W ignore run.py configs/Replica/office3orb-spcd-KL.yaml >log/office3orbfix-spcd-KL.log